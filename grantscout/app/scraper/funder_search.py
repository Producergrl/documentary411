...
def search(cause_area: str) -> list[FunderResult]:
    """
    Run all search queries for the given cause area.
    ...
    for template in _QUERY_TEMPLATES:
        ...
        query = template.format(cause_area=cause_area.strip())
    ...
    # Deduplicate by website within this batch
    ...
    logger.info("search() returning %d unique results", len(unique))
    return unique
