...
html = html.replace(/https:\/\/buy\.stripe\.com\/4gM5kC83RcUN5aK7dN6J206/g, '/.netlify/functions/festival-test-checkout');
...
html = html.replace('Secure Stripe checkout. Immediate PDF access after payment.', 'Temporary $1 live checkout for testing today. Immediate PDF access after payment.');

fs.writeFileSync(file, html);
console.log('Temporary $1 Festival Strategy checkout applied');
